...
class Dataset(object):
    ...
    def readfilenames(self):
        ...
        for f in fh.readlines():
            ...
            f = f.strip('\n')
            filenames = f.split(' ', 5)
            if os.path.exists(os.path.join(self.dataset_dir, self.image_dirname+"/1/"+filenames[0]+".jpg")):
                train_images_list.append(os.path.join(self.dataset_dir, self.image_dirname+"/1/"+filenames[0]+".jpg"))
        ...
        for f in fh.readlines():
            ...
            if os.path.exists(os.path.join(self.dataset_dir, self.image_dirname+"/0/"+filenames[0]+".jpg")):
                test_images_list.append(os.path.join(self.dataset_dir, self.image_dirname+"/0/"+filenames[0]+".jpg"))
                eye_pos.extend([int(value) for value in filenames[1:5]])
